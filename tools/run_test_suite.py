...
COMMANDS = {
    ...
    for command in (
        ...
        Command("v2-migration-contract", ("tests/v2_migration_contract_test.py",)),
        Command("v2-assignment-chain-diff", ("tests/v2_assignment_chain_diff_test.py",)),
        Command("migration-reference-contract", ("tests/migrate_profile_contract_test.py",)),
...
CORE_REGRESSIONS = (
    ...
    "v2-assignment-chain-diff",
    "migration-reference-contract",
